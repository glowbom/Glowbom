...
**Glowbom** is a tech-agnostic app making platform that empowers anyone to build apps and games without the need for coding skills. Glowbom's platform has three layers: mobile for generating AI assets and simple apps, web for mixing apps together and customizing, and desktop for AI-assisted coding.
